...
class DefaultApi
{
     ...
     * @param  int[] $items determined items id to avoid combination with (e.g. FAS which are determined during eligibility) (optional)
     * @param  int $distance estimate of the extension of our network to be built (optional)
     ...
     * Workflows running
     *
     * @param  string $contexts context names (optional)
     * @param  string $states states (optional)
