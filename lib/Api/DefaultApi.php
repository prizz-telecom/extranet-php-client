...
class DefaultApi
{
    ...
    public function getAppointmentWithHttpInfo($id, string $contentType = self::contentTypes['getAppointment'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\Appointment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\Appointment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\Appointment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     */
    public function getAppointments(string $contentType = self::contentTypes['getAppointments'][0])
    {
        list($response) = $this->getAppointmentsWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function getAppointmentsWithHttpInfo(string $contentType = self::contentTypes['getAppointments'][0])
    {
        $request = $this->getAppointmentsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\GetAppointments200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\GetAppointments200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\GetAppointments200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppointmentsAsync(string $contentType = self::contentTypes['getAppointments'][0])
    {
        return $this->getAppointmentsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppointmentsAsyncWithHttpInfo(string $contentType = self::contentTypes['getAppointments'][0])
    {
        $returnType = '\Infracorp\Extranet\Client\Model\GetAppointments200Response';
        $request = $this->getAppointmentsRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAppointmentsRequest(string $contentType = self::contentTypes['getAppointments'][0])
    {
    ...
    public function getAttachmentWithHttpInfo($id, string $contentType = self::contentTypes['getAttachment'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\Attachment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\Attachment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\Attachment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getCommercialOfferItemWithHttpInfo($id, string $contentType = self::contentTypes['getCommercialOfferItem'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\CommercialOfferItem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\CommercialOfferItem' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\CommercialOfferItem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getCommercialOfferSectionWithHttpInfo($id, string $contentType = self::contentTypes['getCommercialOfferSection'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\CommercialOfferSection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\CommercialOfferSection' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\CommercialOfferSection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getInvoiceDetailWithHttpInfo($id, string $contentType = self::contentTypes['getInvoiceDetail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\InvoiceDetail' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\InvoiceDetail' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\InvoiceDetail', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getOfferContextWithHttpInfo($id, $items, $distance = null, string $contentType = self::contentTypes['getOfferContext'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\OfferContext' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\OfferContext' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\OfferContext', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getOfferContextRequest($id, $items, $distance = null, string $contentType = self::contentTypes['getOfferContext'][0])
    {
        ...
        if ($items === null || (is_array($items) && count($items) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $items when calling getOfferContext'
            );
        }
    ...
    public function getOfferContextsShortenedWithHttpInfo($id, $price_list, $groups = null, $autofill_offer = null, $items = null, $distance = null, string $contentType = self::contentTypes['getOfferContextsShortened'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\OfferContextShortened[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\OfferContextShortened[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\OfferContextShortened[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getRunningWorkflowsWithHttpInfo($contexts = null, $states = null, string $contentType = self::contentTypes['getRunningWorkflows'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\GetRunningWorkflows200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\GetRunningWorkflows200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\GetRunningWorkflows200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     */
    public function getServiceContracts($page = null, $items_per_page = null, $sort_id = null, $sort_status = null, $status = null, $legal_entity_id = null, $offer_id = null, $search = null, string $contentType = self::contentTypes['getServiceContracts'][0])
    {
        list($response) = $this->getServiceContractsWithHttpInfo($page, $items_per_page, $sort_id, $sort_status, $status, $legal_entity_id, $offer_id, $search, $contentType);
        return $response;
    }
     ...
     */
    public function getServiceContractsWithHttpInfo($page = null, $items_per_page = null, $sort_id = null, $sort_status = null, $status = null, $legal_entity_id = null, $offer_id = null, $search = null, string $contentType = self::contentTypes['getServiceContracts'][0])
    {
        $request = $this->getServiceContractsRequest($page, $items_per_page, $sort_id, $sort_status, $status, $legal_entity_id, $offer_id, $search, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceContractsAsync($page = null, $items_per_page = null, $sort_id = null, $sort_status = null, $status = null, $legal_entity_id = null, $offer_id = null, $search = null, string $contentType = self::contentTypes['getServiceContracts'][0])
    {
        return $this->getServiceContractsAsyncWithHttpInfo($page, $items_per_page, $sort_id, $sort_status, $status, $legal_entity_id, $offer_id, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceContractsAsyncWithHttpInfo($page = null, $items_per_page = null, $sort_id = null, $sort_status = null, $status = null, $legal_entity_id = null, $offer_id = null, $search = null, string $contentType = self::contentTypes['getServiceContracts'][0])
    {
        $returnType = '\Infracorp\Extranet\Client\Model\GetServiceContracts200Response';
        $request = $this->getServiceContractsRequest($page, $items_per_page, $sort_id, $sort_status, $status, $legal_entity_id, $offer_id, $search, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServiceContractsRequest($page = null, $items_per_page = null, $sort_id = null, $sort_status = null, $status = null, $legal_entity_id = null, $offer_id = null, $search = null, string $contentType = self::contentTypes['getServiceContracts'][0])
    {
