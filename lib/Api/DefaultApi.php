...
class DefaultApi
{
    ...
    public function getClientContractWithHttpInfo($id, string $contentType = self::contentTypes['getClientContract'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\ClientContract' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\ClientContract' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\ClientContract', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getClientContractsWithHttpInfo($page = null, $items_per_page = null, $sort_id = null, $sort_create_date = null, $client_legal_entity_id = null, $legal_entity_id = null, $search = null, string $contentType = self::contentTypes['getClientContracts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\GetClientContracts200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\GetClientContracts200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\GetClientContracts200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getEligibilityBasedOfferContextsShortenedWithHttpInfo($id, $legacy = null, string $contentType = self::contentTypes['getEligibilityBasedOfferContextsShortened'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Infracorp\Extranet\Client\Model\EligibilityBasedOfferContextShortened[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Infracorp\Extranet\Client\Model\EligibilityBasedOfferContextShortened[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Infracorp\Extranet\Client\Model\EligibilityBasedOfferContextShortened[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
