...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://sourceforge.priv.ithd.fr:8000';
    ...
    {
        $report  = 'PHP SDK (Infracorp\Extranet\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            ...
            [
                "url" => "https://dev.prizz-telecom.fr/external-api",
