...
class GetEligibility implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'lastlog' => '\InfracorpExtranetClient\Model\GetEligibilityLastlog',
        'state' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lastlog', $data ?? [], null);
    ...
    */
     ...
     * Sets response
     *
     * @param \InfracorpExtranetClient\Model\EligibilityResult[]|null $response Eligibility results
     *
     * @return self
     */
     ...
     * Gets lastlog
     *
     * @return \InfracorpExtranetClient\Model\GetEligibilityLastlog|null
     */
    public function getLastlog()
    {
        return $this->container['lastlog'];
    }

    /**
     * Sets lastlog
     *
     * @param \InfracorpExtranetClient\Model\GetEligibilityLastlog|null $lastlog lastlog
     *
     * @return self
     */
    ...
    {
        if (is_null($lastlog)) {
            throw new \InvalidArgumentException('non-nullable lastlog cannot be null');
        }
        $this->container['lastlog'] = $lastlog;
     ...
     * Sets state
     *
     * @param string|null $state Workflow state
     *
     * @return self
     */
