...
/**
 * CommercialOfferVatDetailInner Class Doc Comment
 *
 * @category Class
 * @package  InfracorpExtranetClient
 * @author   OpenAPI Generator team
 ...
 */
class CommercialOfferVatDetailInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommercialOffer_vatDetail_inner';
    ...
    */
     ...
     *
     * @param int|null $total_without_taxes total HT pour cette tva
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total montant pour cette tva
     *
     * @return self
     */
